            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-10 text-center">
                    <div class="sign-in-area">
                        ...
                        <form class="contact-form-wrap" action="php/login.php" method="post">
                            ...
                            <div class="single-input-wrap input-group">
                                ...
                                <input id="inp-2" type="password" class="form-control" placeholder="Enter your password" name="password">
                            </div>
                            <div class="row">
                        ...
                        <p>Have you didn't any account? <a href="#popup-box">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="row">
                        ...
                        <a href="sign-up.php">
                            <div class="team-one__img-box">
                                <div class="team-one__img">
                                    <img src="assets/img/team-one-img-1.jpg" alt="">
                                </div>
                            </div>
                        </a>
                ...
                <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay="200ms">
                    <!--Team One Single-->
                    <div class="team-one__single">
                        <a href="sign-seller.php">
                            <div class="team-one__img-box">
                                <div class="team-one__img">
                                    <img src="assets/img/team-one-img-2.jpg" alt="">
                                </div>
                            </div>
                        </a>
                    </div>
